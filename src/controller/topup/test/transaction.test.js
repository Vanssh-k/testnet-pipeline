...
test('Get Transaction Details Main Case: GET /record_transaction', async () => {
  const data = {
    txHash:
      '0x485e21cbc8a5c76c83e6e062d2e175face12bafc6c6ae49a4f4fd8837db91a7d',
...
test('Get Transaction Details Main Case: GET /get_user_transactions', async () => {
  await supertest(app)
    .get(
      '/api/topup/get_user_transactions?publicKey=0x4e6d5be93ab7c1f75e30dd5a7f574f42f675eed3'
    )
    .expect(200)
    .then((response) => {
      const txDetails = JSON.parse(response.text)
...
test('Get Transaction Details Record Not Found: GET /get_user_transactions', async () => {
  await supertest(app)
    .get(
      '/api/topup/get_user_transactions?publicKey=0x75a22ede971080c8448c46de6ae5df3f64c67435'
    )
    .expect(200)
    .then((response) => {
      const txDetails = JSON.parse(response.text)
