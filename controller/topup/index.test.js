...
test('Get Sub Domain Main Case: GET /get_subdomain', async () => {
    await supertest(app)
        .get(
            '/api/gateway/get_subdomain?publicKey=0x75a22ede971080c8448c46de6ae5df3f64c67475'
        )
        .expect(200)
        .then((response) => {
...
test('Get Sub Domain Not Found: GET /get_subdomain', async () => {
    await supertest(app)
        .get(
            '/api/gateway/get_subdomain?publicKey=0x487fc2fE07c593EAb555729c3DD6dF85020B5161'
        )
        .expect(404)
}, 30000)
...
test('Get Transaction Details Main Case: GET /get_transaction_details', async () => {
    await supertest(app)
        .get(
            '/api/gateway/get_transaction_details?publicKey=0x75a22ede971080c8448c46de6ae5df3f64c67475'
        )
        .expect(200)
        .then((response) => {
...
test('Get Transaction Details Record Not Found: GET /get_transaction_details', async () => {
    await supertest(app)
        .get(
            '/api/gateway/get_transaction_details?publicKey=0x75a22ede971080c8448c46de6ae5df3f64c67435'
        )
        .expect(200)
        .then((response) => {
            const txDetails = JSON.parse(response.text)
